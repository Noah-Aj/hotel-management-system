...
class Loginwindow3:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\SAMSUNG\Desktop\tkinter\hotel management system\images\login.jpg")
        ...
        #login button
        loginbtn=Button(frame,text="Login",command=self.login2,font=("times new roman",14,"bold"),bd=3,relief=GROOVE,fg="white",bg="red",activeforeground="white",activebackground="blue")
