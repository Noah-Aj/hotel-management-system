...
class Roomavailable:
    def __init__(self,root):
        ...
        tableframe=LabelFrame(self.root,bd=2,relief=RIDGE,text="View Details Of Rooms Available",font=("times new roman",12,"bold"),padx=2)
        ...
        cust_btn=Button(btn_frame,text="BOOK ROOM HERE",command=self.roomboking,width=20,font=("times new roman",15,"bold"),bg="black",fg="gold",bd=0,cursor="hand2")
